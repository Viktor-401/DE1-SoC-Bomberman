...
void calibrate_accel_xy()
{
    ...
    accel_reg_read(DATA_Y1, &y_data_1);
    accel_y_offset = y_data_1;
    accel_y_offset = accel_y_offset << 8;
    accel_y_offset += y_data_0;
    printf("Calibração concluída. Offset do eiyo y: %d\n", accel_y_offset);
}
